...
public class Exercise {
    ...
    private String category; // ex: "Musculation", "Cardio", "Flexibilité"
    
    @Column(name = "muscle_group", length = 100)
    private String muscleGroup; // ex: "Pectoraux", "Dos", "Jambes"
    
    @Column(name = "equipment_needed", length = 100)
    private String equipmentNeeded; // ex: "Haltères", "Barre", "Poids du corps"
